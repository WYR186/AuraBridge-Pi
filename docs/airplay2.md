...
- The verified Safe Sink gain is `0.10`, so quiet playback is expected.
- The optional source arbiter is not required for basic AirPlay playback and
  must not default to protocol-level Stop.
