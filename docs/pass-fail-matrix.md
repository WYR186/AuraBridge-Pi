...
| `safe-volume.sh` | Sets default sink to 0.30 and unmutes | Runs but default sink is unclear | `wpctl` missing or cannot reach PipeWire | Stop playback tests; fix PipeWire user session |
